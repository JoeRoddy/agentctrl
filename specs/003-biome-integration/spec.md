...
As a developer working on agentctl, I want code formatting and linting to run automatically during the build process so that code quality standards are consistently enforced without manual intervention.
