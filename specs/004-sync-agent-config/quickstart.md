...
## Prerequisites
- Canonical config exists at `/Users/joeroddy/Documents/dev/projects/open-source/agentctrl/agents/skills`.
...
node /Users/joeroddy/Documents/dev/projects/open-source/agentctrl/dist/cli.js sync --only claude
```
...
```bash
node /Users/joeroddy/Documents/dev/projects/open-source/agentctrl/dist/cli.js sync --skip unknown
node /Users/joeroddy/Documents/dev/projects/open-source/agentctrl/dist/cli.js sync --skip codex --only claude
```
