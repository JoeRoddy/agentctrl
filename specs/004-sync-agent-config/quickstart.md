...
## Prerequisites
- Canonical config exists at `/Users/joeroddy/Documents/dev/projects/open-source/agentctl/agents/skills`.
...
node /Users/joeroddy/Documents/dev/projects/open-source/agentctl/dist/cli.js sync --only claude
```
...
```bash
node /Users/joeroddy/Documents/dev/projects/open-source/agentctl/dist/cli.js sync --skip unknown
node /Users/joeroddy/Documents/dev/projects/open-source/agentctl/dist/cli.js sync --skip codex --only claude
```
